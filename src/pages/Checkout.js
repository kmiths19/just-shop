        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <div className='lg:col-span-3'>
                    <form className='bg-white p-5 my-12'>
                        <div className="space-y-12">
                            <div className="border-b border-gray-900/10 pb-12">
                                <h2 className="text-xl font-semibold leading-7 text-gray-900">Add an Address</h2>
                                <p className="mt-1 text-sm leading-6 text-gray-600">Enter your shipping address below</p>
                                    ...
                                    {addresses.map((address) => (
                                        <li key={address.email} className="flex justify-between gap-x-6 py-5">
                                            ...
                                            <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                                <p className="text-sm leading-6 text-gray-900">{address.street},&nbsp;{address.city}</p>
                                                <p className="mt-1 text-xs leading-5 text-gray-500">
                                                    {address.state},&nbsp;PIN: {address.pinCode}</p>
                                            </div>
                                        </li>
                                    ))}
                                </ul>
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                <div>
                                                    <div className="flex justify-between text-base font-medium text-gray-900">
                                                        ...
                                                        <p className="ml-4"><sup>$</sup>{item.price}</p>
                                                    </div>
