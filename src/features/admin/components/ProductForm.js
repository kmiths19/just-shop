          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <select className='rounded-md shadow-sm' {...register('brand', { required: 'Brand is required' })}>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <select className='rounded-md shadow-sm' {...register('category', { required: 'Category is required' })}>
